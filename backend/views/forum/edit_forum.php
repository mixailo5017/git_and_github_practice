	...
	<div id="contentwrapper" class="contentwrapper">
		 ...
		 <div class="floatleft clearfix" style="position:relative; width:100%;">
                ...
                <div class="floatleft" style="padding-left:10px;">
					...
					$opt['forum_banner_form'] = array('banner_filename' => array('name' => 'banner_filename','id' => 'banner_filename'),
													 'exertcount'=>array('name'=>'expertcount','id'=>'expertcount','size'=>'5','maxlength'=>'3','value'=>$forum_detail['expertcount']),
													 'projectcount'=>array('name'=>'projectcount','id'=>'projectcount','size'=>'5','maxlength'=>'3','value'=>$forum_detail['projectcount']));
					?>
		...
		<?php echo form_open_multipart("forum/update_forum",array("id"=>"update_forum")); ?>
            ...
            <div style="width:900px;">
                ...
                <div style="width:97%; display:table;">
                    <div class="contenttitle2" style="float:left;">
                        <h3>Expert List</h3>
                    </div>
                    <div style="float:right; margin:15px 0px 0px 0px;">
                       <span style="float:right;"><?php echo form_input($opt['forum_banner_form']['exertcount']); ?></span>
                        <span style="float:right; padding:6px 10px 0px 0px;"><?php echo form_label("Experts Limit:","exertcount",array('class' => 'left_label')); ?></span>
					</div>
                </div>    
                    <?php
			...
			?>
                ...
                <div style="width:97%; display:table;">
                    ...
                    <div style="float:right; margin:15px 0px 0px 0px;">
                    <span style="float:right;"><?php echo form_input($opt['forum_banner_form']['projectcount']); ?></span>
                    	<span style="float:right; padding:6px 10px 0px 0px;"><?php echo form_label("Project Limit:","projectcount",array('class' => 'left_label')); ?></span>
