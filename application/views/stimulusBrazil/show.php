...
<div id="content" class="clearfix" style="width: 100%">
    ...
    <div style="padding-top: 10px">
        <div style="width:50%; display: inline-block">
            <?php $this->load->view('stimulusBrazil/_details_blue', array_merge($projects, array('id' => $details['id'])));?>
        </div><!-- end #col1 -->

        <div style="width: 50%; float: right; height: 650px; overflow: scroll">
            <div style="float:left;">
                <?php echo form_open('/stimulusBrazil', array(
                ...
                <a href="/stimulusBrazil" style="float: right; padding-left: 10px"><?php echo 'Reset Filters';?></a>

                <input type="hidden" name="sort" value="<?php echo $sort ?>">
                <?php echo form_close(); ?>
            </div>

            <?php $this->load->view('stimulusBrazil/_projects_preview', array_merge($projects, array('id' => $details['id'])));?>
        </div><!-- end #col2 -->
    </div>
