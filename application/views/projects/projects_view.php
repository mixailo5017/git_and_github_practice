<div id="content" class="clearfix">
		<div id="col2" class="projects">
            ...
            <ul>
                <li><a href="#tabs-1"><?php echo lang('Overview')    ?></a></li>
                <li><a href="#tabs-2" <?php echo $style_fundamental  ?>><?php echo lang('Fundamentals') ?></a></li>
                <li><a href="#tabs-3" <?php echo $style_financial    ?>><?php echo lang('Financial')    ?></a></li>
                <li><a href="#tabs-7" <?php echo $style_regulatory   ?>><?php echo lang('Regulatory')   ?></a></li>
                <li><a href="#tabs-4" <?php echo $style_participants ?>><?php echo lang('Participants') ?></a></li>
                <li><a href="#tabs-5" <?php echo $style_procurement  ?>><?php echo lang('Procurement')  ?></a></li>
                <li><a href="#tabs-6" <?php echo $style_files        ?>><?php echo lang('Files')        ?></a></li>
            </ul>
