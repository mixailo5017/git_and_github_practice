<section class="main-content container">
    <h1 class="h1-xl"><?php echo lang('PrivacyPolicy') ?></h1>

    <div class="general">
        <div class="interior">
            <small><em>Last modified: September 28, 2014</em></small>

            <p>GlobalViP LLC ("us", "we", or "our") operates the website located at http://www.globalvipprojects.com, http://store.globalvipprojects.com, and such other subdomains of globalvipprojects.com as may from time to time be introduced (“the Site”), and provides services offered through the Site (collectively, “the Services”).</p>
            <p>This page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.</p>
            <p>We will not use or share your information with anyone except as described in this Privacy Policy.</p>
            <p><strong>We use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy.</strong> Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our <a href="/terms">Terms of Service</a>.</p>
            ...
            <p>In particular, we make use of Google Analytics’ “user ID” function. This function records the user’s identification number and serves the purpose of tracking individual user behavior, between sessions and between devices.</p>
            ...
            <p>If GlobalViP LLC is involved in a merger, acquisition or asset sale, your Personal Information may be transferred as a business asset. In such cases, we will provide notice before your Personal Information is transferred and/or becomes subject to a different Privacy Policy.</p>
            ...
            <p>This Privacy Policy is effective as of September 28, 2014 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
            <p>We reserve the right to update or change our Privacy Policy at any time and you should check this Privacy Policy periodically. Your continued use of the Service after we post any modifications to the Privacy Policy on this page will constitute your acknowledgment of the modifications and your consent to abide and be bound by the modified Privacy Policy.</p>
            <p>If we make any material changes to this Privacy Policy, we will notify you either through the email address you have provided us, or by placing a prominent notice on our website.</p>

            <h2>Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:info@globalvipprojects.com">info@globalvipprojects.com</a>.</p>
        </div>
    </div>
    <br>
