        ...
        <div class="inner clearfix">
            ...
            foreach ($experts as $key => $expert) {
                ...
                <div class="project_listing <?php if ($i == 3) { echo 'project_listing_last'; }  ?> left">
                    ...
                    <p>
                        <strong><?php echo lang('Sector') ?>:</strong>&nbsp;&nbsp;&nbsp;<?php  echo empty($expert['expert_sector']) ? '&mdash;' : $expert['expert_sector'] ?><br>
                        <strong><?php echo lang('Discipline') ?>:</strong>&nbsp;&nbsp;&nbsp;<?php echo empty($expert['discipline']) ? '&mdash;' : $expert['discipline'] ?>
                    </p>
                </div>
                <?php $i++; if ($i == 4) $i = 0; } ?>
