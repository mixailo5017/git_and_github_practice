			...
			?>
				<li class="" id="row_id_<?php echo $val["id"]; ?>">
					...
					<?php } ?>
						...
						<a class="right delete" href="#projects/delete_project_files">Delete</a>
		
						<a class="right edit" id="edit_project_files_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
					...
					<div class="edit">
						...
						<?php 
							...
							<?php echo form_submit('ufiles_submit', 'Update','class = "light_green btn_lml"');?>
	...
	if(count($procurement_services_data) > 0)
	{
			...
			<li class="" id="row_id_<?php echo $val["id"]; ?>">
				<div class="view clearfix">
					...
					<a class="right delete" href="#projects/delete_procurement_services">Delete</a>

					<a class="right edit" id="edit_procurement_services_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
	...
	if(count($procurement_technology_data) > 0)
	{
			...
			<li class="" id="row_id_<?php echo $val["id"]; ?>">
				<div class="view clearfix">
					...
					<a class="right delete" href="#projects/delete_procurement_technology">Delete</a>

					<a class="right edit" id="edit_procurement_technology_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
	...
	if(count($machinery_data) > 0)
	{
			...
			<li class="" id="row_id_<?php echo $val["id"]; ?>">
					<div class="view clearfix">
						...
						<a class="right delete" href="#projects/delete_machinery">Delete</a>

						<a class="right edit" id="edit_machinery_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
	...
	if(count($participants_owners_data) > 0)
	{
			...
			<li class="" id="row_id_<?php echo $val["id"];?>">
				...
				<div class="view clearfix">
					...
					<a class="right delete" href="#projects/delete_participants_owners">Delete</a>

					<a class="right edit" id="edit_participants_owners_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
				...
				<?php 
					...
					<?php echo form_submit('uowners_submit', 'Update','class = "light_green btn_lml"');?>
	...
	if(count($participants_companies_data) > 0)
	{
			...
			<li class="" id="row_id_<?php echo $val["id"];?>">
				...
				<div class="view clearfix">
					...
					<a class="right delete" href="#projects/delete_participants_companies">Delete</a>
		
					<a class="right edit" id="edit_participants_companies_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
				...
				<?php 
					...
					<?php echo form_submit('ucompanies_submit', 'Update','class = "light_green btn_lml"');?>
			...
			?>
				<li class="" id="row_id_<?php echo $val["id"];?>">
					...
					<div class="view clearfix">
						...
						<a class="right delete" href="#projects/delete_participants_political">Delete</a>
	
						<a class="right edit" id="edit_participants_political_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
					...
					<?php 
						...
						<?php echo form_submit('upolitical_submit', 'Update','class = "light_green btn_lml"');?>
...
if($formname == 'participants_public')
{
	if(count($participants_public_data) > 0)
	{
			...
			<div class="view clearfix">
				...
				<a class="right delete" href="#projects/delete_participants_public">Delete</a>

				<a class="right edit" id="edit_participants_public_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
			...
			<?php 
				...
				<?php echo form_submit('upublic_submit', 'Update','class = "light_green btn_lml"');?>
	...
	if(count($regulatory_data) > 0)
	{
			...
			<li class="" id="row_id_<?php echo $val["id"]; ?>">
				<div class="view clearfix">
					...
					<span class="left"><?php echo $val["file"]; ?></span>
			
					<a class="right delete" href="#projects/delete_regulatory">Delete</a>
			
					<a class="right edit" id="edit_regulatory_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
				...
				<div class="edit">
					...
					<?php 
						...
						<div class="fld" style="width:500px;">
							...
							<?php echo form_input($opt['update_regulatory_form']['project_regulatory_filename']);?>
							<div class="errormsg"></div>
						</div>
						...
						<?php echo form_submit('uragulatory_submit', 'Update','class = "light_green btn_lml"');?>
			...
			?>
				<li id="row_id_<?php echo $val["id"];?>" class="">
						...
						<div class="view clearfix">
							...
							<a href="#projects/delete_critical_participants" class="right delete">Delete</a>
	
							<a onclick="rowtoggle(this.id);" href="javascript:void(0);" id="edit_critical_participant_<?php echo $val["id"];?>" class="right edit">Edit</a>
			...
			?>
				<li id="row_id_<?php echo $val["id"];?>" class="">
					...
					<div class="view clearfix">
						...
						<a href="#projects/delete_roi" class="right delete">Delete</a>

						<a onclick="rowtoggle(this.id);" href="javascript:void(0);" id="edit_roi_<?php echo $val["id"];?>" class="right edit">Edit</a>
			...
			?>
				<li id="row_id_<?php echo $val["id"];?>" class="">
						...
						<div class="view clearfix">
							...
							<a href="#projects/delete_fund_sources" class="right delete">Delete</a>
	
							<a onclick="rowtoggle(this.id);" href="javascript:void(0);" id="edit_fund_sources_<?php echo $val["id"];?>" class="right edit">Edit</a>
	...
	if(count($studies_data) > 0)
	{
			...
			?>
				...
				<div class="view clearfix">
					...
					<span class="left">Study File</span>
		
					<span class="left middle">
						<strong><?php echo $val["title"]; ?></strong><br><?php echo $val["description"]; ?>
					</span>
		
						<a class="right delete" href="#projects/delete_studies">Delete</a>
		
						<a class="right edit" id="edit_studies_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
				...
				<div class="edit add_new">
						...
						<?php echo form_submit('ustudies_submit', 'Update','class = "light_green btn_lbl"');?>
	...
	if(count($environment_data) > 0)
	{
			...
			?>
				...
				<div class="view clearfix">
					...
					<span class="left">Environment File</span>
		
					<span class="left middle">
						<strong><?php echo $val["title"]; ?></strong><br><?php echo $val["description"]; ?>
					</span>
		
						<a class="right delete" href="#projects/delete_environment">Delete</a>
		
						<a class="right edit" id="update_environment_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
				...
				<?php echo form_open('projects/update_environment/'.$slug,array('id'=>'update_environment_form_'.$val["id"],'name'=>'update_environment_form_'.$val["id"],'method'=>'post','class'=>'ajax_form'));?>
						...
						<?php echo form_submit('uenvironment_submit', 'Add new','class = "light_green btn_lbl"');?>
	...
	if(count($design_issue_data) > 0)
	{
			...
			?>
				...
				<li class="" id="row_id_<?php echo $val["id"];?>">
					...
					<div class="view clearfix">	
						<span class="left">Design Issues</span>
					
						<span class="left middle">
							<strong><?php echo $val["title"]; ?></strong><br><?php echo $val["description"]; ?>
						</span>
						
						<a class="right delete" href="#projects/delete_design_issue">Delete</a>

						<a class="right edit" id="edit_design_issue_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
					...
					<div class="edit">
						...
						<?php echo form_submit('udesign_submit', 'Update','class = "light_green btn_lbl"');?>
		...
		?>
				...
				<li class="" id="row_id_403">
					...
					<div class="view clearfix">
						...
						<span class="left middle"><strong>Lat: </strong><?php echo $val["latitude"]; ?></span>

						<span class="left middle"><strong>Lng: </strong><?php echo $val["longitude"]; ?></span>

						<a class="right delete" href="#projects/delete_map_point">Delete</a>

						<a class="right edit" id="edit_map_point_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
					...
					<div class="edit">
						...
						<?php echo form_open('projects/update_map_point/'.$slug,array('id'=>'update_map_points_form_'.$val["id"],'name'=>'update_map_points_form_'.$val["id"],'method'=>'post','class'=>'ajax_form'));?>
							...
							<?php echo form_submit('upoints_submit', 'update','class = "light_green btn_lml"');?>
...
if($formname == 'project_engineering')
{
	if(count($engineering_data) > 0)
	{
		...
		<div class="view clearfix">
			...
			<a class="right delete" href="#projects/delete_engineering">Delete</a>

			<a class="right edit" id="edit_engineering_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
		...
		<div class="edit">
			<?php echo form_open('projects/update_engineering/'.$slug,array('id'=>'update_engineering_form_'.$val["id"],'name'=>'update_engineering_form_'.$val["id"],'method'=>'post','class'=>'ajax_form'));?>
				...
				<?php echo form_submit('uengineering_submit', 'Update','class = "light_green btn_lml"');?>
...
?>
	<li class="" id="row_id_<?php echo $val["id"]; ?>">
			<div class="view clearfix">
				...
				<a class="right delete" href="#projects/delete_executive">Delete</a>

				<a class="right edit" id="edit_executive_<?php echo $val["id"]; ?>" href="javascript:void(0);"  onclick="rowtoggle(this.id);">Edit</a>
			...
			<div class="edit">
				...
				<div style="<?php echo $dropdownStyle;?> clear:both;" class="role_other">
					<?php echo form_label("Other:","",array("class"=>"left_label")); ?>
...
?>
	<li class="" id="row_id_<?php echo $val["id"]; ?>">
		<div class="view clearfix">
			...
			<a class="right delete" href="#projects/delete_organization">Delete</a>

			<a class="right edit" href="javascript:void(0);" id="edit_organization_<?php echo $val["id"];?>" onclick="rowtoggle(this.id);">Edit</a>
	...
	foreach($education_data as $key=>$edu)
	{
		...
		<?php echo form_open($formlink,array('id'=>'expertise_education_form_'.$edu["educationid"],'name'=>'expertise_education_form_'.$edu["educationid"],'method'=>'post','class'=>'ajax_form'));
			...
			<div class="top clearfix">						
				...
				<strong class="left">Edit Education</strong>
			...
			<div class="inner">
				...
				<div <?php if($edu['degree'] != "Other") { ?>style="display:none" <?php } ?>>
					<?php echo form_label('Other:', 'education_degree_other', $opt['expertise_education_form']['lbl_major']);?>
				...
				<div>
					<?php echo form_submit('edu_submit', 'Save Education','class = "light_green no_margin_left"');?>
					<input type="button" value="Cancel" name="cancel" class="light_gray no_margin_left" onclick="javascript: $(this).parents('.education_edit').hide();">
				</div>
...
if($formname == "project_comment" && $type == "view")
{
	...
	{
		$i = 1;
		echo heading("Comments:",3);
		foreach($project_comment_data as $comments)
		{
	?>
		<div id="comment_<?php echo $comments["id"]; ?>">
		<div><div class="fld" style="width:100%"><?php echo $comments["comment"]; ?></div><div style="float:left; position:absolute; right:15px;"><a href="javascript:void(0)" onclick="delete_maxtrix_action('projects/delete_comment','<?php echo $comments["id"]; ?>','comment_<?php echo $comments["id"]; ?>')">Delete</a></div></div>
			...
			<div id="sector_row_<?php echo $sec["id"];?>" class="sector_row">
				<div class="clearfix">
					<p class="left"><strong><?php echo $sec['sector'];?></strong> <br/>(<?php echo $sec['subsector'];?>)</p>
						<a href="javascript:void(0);" id="delete_sector_<?php echo $sec["id"];?>" onclick="show_confirmation(this.id);" class="right delete">Delete</a>
						<a href="javascript:void(0);" id="edit_sector_<?php echo $sec["id"];?>" class="right edit" onclick="rowtoggle(this.id);">Edit</a>
						
						<div class="delete_sector_<?php echo $sec["id"];?>" style="display:none;">
							<a class="right confirm_yes" href="javascript:void(0);" onclick="delete_maxtrix_action('<?php echo $deletelink;?>','','sector_row_'+<?php echo $sec["id"];?>);">Yes</a>
							<a class="right confirm_no" href="javascript:void(0);" id="reset_<?php echo $sec['id'];?>" onclick="reset_confirmation(this.id);">NO</a>
						</div>
				...
				<div>
					...
					<!-- end .edit -->
					<div class="view clearfix">
							<?php echo form_submit('udateedu_submit', 'Update Sector','class = "light_green no_margin_left" id="btn_add_sector"  style="float:right;margin-right:10px;margin-bottom:10px;"');?>
					</div>
					<?php echo form_close();?>
				</div>
