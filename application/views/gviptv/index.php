...
<div style="padding-right: 2%; padding-left: 2%" class="row">
    ...
    <div class="col-lg-4 col-md-12 mb-4">
        ...
        <a><img class="img-fluid z-depth-1" src="https://d2huw5an5od7zn.cloudfront.net/gviptv/images/Wu.jpg" alt="video" data-toggle="modal" data-target="#modal12"></a>
        <h3>A Catalyst for Necessary Investment: the California I-Bank</h3>
