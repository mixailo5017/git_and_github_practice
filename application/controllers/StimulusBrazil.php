...
class StimulusBrazil extends CI_Controller
{
    ...
    public function show($id)
    {
        ...
        // Render the page
        $this->load->view('stimulusBrazil/header_stimulus', $this->headerdata);
        $this->load->view('stimulusBrazil/show', $data);
    ...
    public function projects($id) {
        ...
        if (empty($details)) {
            redirect('stimulusBrazil', 'refresh');
            exit;
        }
        ...
        $config = array (
            'base_url'   => "/stimulusBrazil/projects/$id?",
            'total_rows' => $total,
            'per_page'   => $perpage,
            'next_link'	 => lang('Next') . '  ' . '&gt;',
            'prev_link'  => '&lt;' . '  ' . lang('Prev'),
        ...
        $this->breadcrumb->append_crumb(lang('B_FORUMS'), '/stimulusBrazil');
        $this->breadcrumb->append_crumb($details['title'], '/stimulusBrazil/' . $details['id']);
        $this->breadcrumb->append_crumb(lang('B_PROJECTS'), '/stimulusBrazil/projects/' . $details['id']);
        ...
        $this->load->view('stimulusBrazil/projects', $data);
        $this->load->view('templates/footer', $this->footer_data);
