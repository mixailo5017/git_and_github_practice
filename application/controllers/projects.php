...
//		$this->output->enable_profiler(FALSE);
    ...
    public function discussion($id, $discussion_id)
    {
        ...
        if (empty($discussion)) show_404();

        // If the current user doesn't have access to the discussion show 404
        if (! $this->discussions_model->has_access_to($this->uid, $discussion_id)) show_404();
    ...
    public function discussions($id)
    {
        ...
        if (! $this->discussions_model->has_access($this->uid, $id)) show_404();
	...
	*/
	public function edit($params)
	{
		...
		if ($this->input->post('return') != '') {
            ...
            $this->form_validation->set_rules('project_estcompletion', lang('Est.Completion'), 'trim|max_length[10]|callback_valid_period');
