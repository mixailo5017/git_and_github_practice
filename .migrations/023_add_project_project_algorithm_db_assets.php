...
class Migration_Add_project_project_algorithm_db_assets extends CI_Migration
{
  ...
  public function up()
  {
    if(! $this->db->table_exists($this->table)){
      ...
      $this->db->query("ALTER TABLE {$this->table} ADD CONSTRAINT {$this->table}_project_id_1_fkey FOREIGN KEY (project_id_1) REFERENCES public.exp_projects (pid)");
      $this->db->query("ALTER TABLE {$this->table} ADD CONSTRAINT {$this->table}_project_id_2_fkey FOREIGN KEY (project_id_2) REFERENCES public.exp_projects (pid)");
